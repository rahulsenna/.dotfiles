...
# pacman and yay
alias pacin='sudo pacman -S'                 	  # install with pacman
...
alias yayupd='yay -Sua --noconfirm'              # update only AUR pkgs (yay)
alias yayupd2='yay -Syu --noconfirm'              # update standard pkgs and AUR pkgs (yay)
